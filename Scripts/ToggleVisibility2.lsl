...
default
{
    state_entry()
    {
        ...
        for ( l = 1; l <= lHi; l++ ) {
            ...
            params_0 = [PRIM_LINK_TARGET, l, PRIM_COLOR, ALL_SIDES, rgb, 0.0];
            params_1 = [PRIM_LINK_TARGET, l, PRIM_COLOR, ALL_SIDES, rgb, 1.0];
